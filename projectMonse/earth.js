      ...
      for(latInd = 0; latInd < lats.length; latInd++) {
          ...
          for (lngInd = 1; lngInd < lngs.length; lngInd++) {
              ...
              if (val != "NA") {
                  ...
                  globe.plugins.pings.add(parseInt(lng), parseInt(lat), { color: color, ttl: 20000, angle:5 });
